...
public:
	// Rendu des positions en tant que points OpenGL
...
public:
	...
	// Met à jour la scène en appelant les systèmes associés
	void update(float dt) {
		movementSystem.update(positions, velocities, dt);
	}

	// Rendu de la scène en appelant les systèmes associés
	void render() {
